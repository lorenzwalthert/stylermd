...
custom line width you can set with the option `stylermd.linewidth`, i.e.
`options("stylermd.linewidth", 60)`. It supports:

* Both adding and removing linebreaks for float text, enumerations, bullet
  lists.
...
* the RStudio Addins (restarting RStudio after installation). One styles the
  ...
  example in your `.Rprofile` to enable saving after styling.
**Example**
